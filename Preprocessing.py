...
def get_train_test(df):
    ...
    class1_x_train, class1_x_test, class1_y_train, class1_y_test = train_test_split(class1, y1, test_size=0.4, random_state=42)
    class2_x_train, class2_x_test, class2_y_train, class2_y_test = train_test_split(class2, y2, test_size=0.4, random_state=42)
    class3_x_train, class3_x_test, class3_y_train, class3_y_test = train_test_split(class3, y3, test_size=0.4, random_state=42)
